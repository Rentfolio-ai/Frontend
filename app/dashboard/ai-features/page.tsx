      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-slate-800/50 border-slate-700/50 hover:border-purple-500/30 transition-colors">
            ...
            <CardContent>
              <p className="text-gray-400 text-sm">
                Ask naturally: &ldquo;Find me properties in Austin under $500k with good cap rates&rdquo;
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800/50 border-slate-700/50 hover:border-green-500/30 transition-colors">
            ...
            <CardContent>
              <p className="text-gray-400 text-sm">
                AI asks contextual follow-ups: &ldquo;Would you like me to generate a report?&rdquo; or export data.
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <ul className="text-gray-400 space-y-1">
                  <li>• &ldquo;Find me properties in Austin under $500k&rdquo;</li>
                  <li>• &ldquo;Show me high cap rate properties&rdquo;</li>
                  <li>• &ldquo;Properties with 3+ bedrooms in good neighborhoods&rdquo;</li>
                </ul>
              </div>
              <div className="space-y-2">
                <h4 className="text-blue-300 font-medium">Analysis & Reports</h4>
                <ul className="text-gray-400 space-y-1">
                  <li>• &ldquo;What&rsquo;s the valuation for 123 Main St?&rdquo;</li>
                  <li>• &ldquo;Generate a portfolio analysis report&rdquo;</li>
                  <li>• &ldquo;Compare ROI for my top 3 properties&rdquo;</li>
                </ul>
              </div>
            </div>
          </CardContent>
