...
export class ErrorBoundary extends Component<Props, State> {
    ...
    public render() {
        if (this.state.hasError) {
            return (
                <div className="h-full flex flex-col items-center justify-center p-8 text-foreground" style={{ backgroundColor: 'hsl(var(--background))' }}>
                    <div className="max-w-md w-full rounded-xl bg-black/[0.03] border border-black/[0.08] p-6 text-center">
                        ...
                        <h2 className="text-[15px] font-semibold text-foreground/85 mb-1">
