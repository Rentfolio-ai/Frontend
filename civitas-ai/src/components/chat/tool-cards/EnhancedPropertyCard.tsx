        ...
        <div className="relative aspect-video overflow-hidden">
          ...
          <div className="absolute top-3 left-3 right-3 flex items-start justify-between">
            ...
            <motion.div
              ...
              className="px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold text-sm shadow-lg backdrop-blur-sm flex items-center gap-1.5"
            >
          ...
          {isPositiveCashFlow && (
            <motion.div
              ...
              className="absolute bottom-3 left-3 px-2.5 py-1 rounded-full bg-green-500/90 backdrop-blur-sm flex items-center gap-1.5 text-white text-xs font-medium shadow-lg"
            >
          ...
          {capRate && parseFloat(capRate) > 8 && (
            <motion.div
              ...
              className="absolute bottom-3 right-3 px-2.5 py-1 rounded-full bg-blue-500/90 backdrop-blur-sm flex items-center gap-1 text-white text-xs font-medium shadow-lg"
            >
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            {property.sqft && (
              <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg bg-white/5">
                ...
                <span className="text-white text-xs font-medium">{property.sqft.toLocaleString()}</span>
              </div>
            )}
          </div>
          ...
          <div className="pt-3 mt-3 border-t border-white/10 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/50">Est. Rent</span>
              <span className="text-green-400 font-medium">
                ${Math.round(estimatedRent).toLocaleString()}/mo
              </span>
            </div>
            <div className="flex items-center justify-between text-xs">
              <span className="text-white/50">Est. Mortgage</span>
              <span className="text-white/70 font-medium">
                ${Math.round(estimatedMortgage).toLocaleString()}/mo
              </span>
            </div>
            <div className="flex items-center justify-between text-xs pt-2 border-t border-white/5">
              <span className="text-white/70 font-medium">Cash Flow</span>
          ...
          >
            <button className="w-full py-2 rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm font-medium hover:from-purple-600 hover:to-blue-600 transition-colors">
              View Full Analysis
            </button>
          </motion.div>
        </div>
