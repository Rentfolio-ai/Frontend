          ...
          <div className="flex flex-wrap gap-2 pt-2">
            ...
            {properties.map((prop) => (
              <div key={prop._index} className="flex items-center gap-1">
                ...
                {onOpenDealAnalyzer && (
                  <button
                    onClick={() => onOpenDealAnalyzer(null, 'LTR', prop.price, prop.address)}
                    className="px-2 py-1 rounded bg-primary/10 hover:bg-primary/20 text-primary text-xs font-medium transition-colors"
                    title="Analyze Deal"
                  >
                    Analyze
                  </button>
