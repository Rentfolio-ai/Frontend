  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-[11px] font-semibold uppercase tracking-widest text-white/25">Saved Properties</h3>
      ...
      {visible.length === 0 ? (
        ...
        <div className="rounded-xl bg-white/[0.03] border border-white/[0.04] divide-y divide-white/[0.04]">
          {visible.map((bm) => {
            ...
            return (
              <div key={bm.id} className="flex items-center gap-3 px-4 py-3 hover:bg-white/[0.02]">
