...
const SkeletonCard: React.FC = () => (
  <div className="flex flex-col rounded-xl bg-popover border border-black/[0.04]">
    <div className="aspect-[4/3] bg-black/[0.02] animate-pulse rounded-t-xl" />
    <div className="px-3 pt-2.5 pb-3 flex flex-col gap-2 flex-shrink-0">
      <div className="h-5 w-24 bg-black/[0.03] rounded animate-pulse" />
      <div className="h-3.5 w-32 bg-black/[0.02] rounded animate-pulse" />
      <div className="h-3 w-40 bg-black/[0.02] rounded animate-pulse" />
      <div className="h-3 w-36 bg-black/[0.02] rounded animate-pulse" />
    </div>
  </div>
);
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      >
        {isLoading ? (
          ...
          <div className="flex items-center justify-center py-16">
            <p className="text-[13px] text-muted-foreground/50">No properties found. Try adjusting your filters.</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
      ...
      {totalPages > 1 && !isLoading && (
        <div className="flex-shrink-0 flex items-center justify-between px-4 py-2.5 border-t border-black/[0.06] bg-card">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded-lg text-muted-foreground/70 hover:text-foreground/70 hover:bg-black/[0.03]
