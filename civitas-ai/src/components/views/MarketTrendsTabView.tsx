...
export const MarketTrendsTabView: React.FC = () => {
  return (
    <div 
      ...
      <div className="max-w-2xl mx-auto text-center px-8">
        ...
        >
          <p className="text-lg text-white/80 font-['Inter_Tight'] leading-relaxed">
            Monitor real-time market trends and alerts. Get AI-powered insights on the best markets for short-term rental investments.
          </p>
        </motion.div>
