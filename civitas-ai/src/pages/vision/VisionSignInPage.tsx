        ...
        <div className="rounded-2xl p-8 md:p-10 bg-[#161618] border border-white/[0.08] shadow-2xl">
          ...
          <div className="space-y-3 mb-8">
            ...
            <button
              ...
              className="w-full h-12 rounded-xl font-sans font-medium flex items-center justify-center gap-3 transition-all disabled:opacity-50 bg-[#1A1A1C] hover:bg-[#222224] border border-white/[0.08] text-[#FBF9F7] focus:ring-2 focus:ring-violet-500/20 outline-none"
            >
          ...
          {!showSSOInput ? (
            ...
            <form onSubmit={handleSSOSignIn} className="space-y-4">
              <div>
                <label htmlFor="sso-email-vision" className="block text-sm font-medium text-white/80 mb-2 font-sans">
                  Work email
                </label>
                <input
                  id="sso-email-vision"
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#1A1A1C] border border-white/[0.08] text-[#FBF9F7] placeholder-white/20 focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all font-sans text-[15px]"
                  autoFocus
                />
              </div>
